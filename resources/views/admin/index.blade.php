...
@section('content')
    ...
    <section class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white border border-slate-200 rounded-xl p-5">
            ...
            <p class="text-3xl font-black mt-1 text-amber-600">{{ $dipesan }}</p>
        </div>
        <div class="bg-white border border-slate-200 rounded-xl p-5">
            <p class="text-sm text-slate-500">Selesai</p>
            <p class="text-3xl font-black mt-1 text-emerald-600">{{ $selesai }}</p>
        </div>
        <div class="bg-white border border-slate-200 rounded-xl p-5">
    ...
    <section class="grid sm:grid-cols-2 gap-4 mb-6">
        <div class="bg-white border border-slate-200 rounded-xl p-5">
            ...
            <p class="text-3xl font-black mt-1 text-cyan-700">{{ $permintaanAktif }}</p>
        </div>
        <div class="bg-white border border-slate-200 rounded-xl p-5">
            <p class="text-sm text-slate-500">Transaksi Menunggu Persetujuan</p>
            <p class="text-3xl font-black mt-1 text-rose-600">{{ $transaksiMenunggu }}</p>
        </div>
    </section>
    ...
    <section class="grid lg:grid-cols-2 gap-6">
        <div class="bg-white border border-slate-200 rounded-xl overflow-hidden">
            <div class="px-5 py-3 border-b border-slate-100 flex items-center justify-between">
                ...
                <a href="{{ route('admin.items') }}" class="text-sm text-emerald-700 font-semibold hover:underline">Lihat semua</a>
            </div>
        ...
        <div class="bg-white border border-slate-200 rounded-xl overflow-hidden">
            <div class="px-5 py-3 border-b border-slate-100 flex items-center justify-between">
                ...
                <a href="{{ route('admin.users') }}" class="text-sm text-emerald-700 font-semibold hover:underline">Lihat semua</a>
            </div>
